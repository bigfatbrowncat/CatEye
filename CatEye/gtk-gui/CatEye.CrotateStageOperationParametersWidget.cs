...
namespace CatEye
{
	public partial class CrotateStageOperationParametersWidget
	{
		...
		private global::Gtk.ComboBox aspect_type_combobox;
		...
		protected virtual void Build ()
		{
			...
			// Container child table1.Gtk.Table+TableChild
			this.c_x_spinbutton = new global::Gtk.SpinButton (-180, 180, 1);
			this.c_x_spinbutton.CanFocus = true;
			this.c_x_spinbutton.Name = "c_x_spinbutton";
			this.c_x_spinbutton.Adjustment.PageIncrement = 1;
			this.c_x_spinbutton.ClimbRate = 0.1;
			this.c_x_spinbutton.Digits = ((uint)(1));
			this.c_x_spinbutton.Numeric = true;
			this.c_x_spinbutton.Value = 0.5;
			this.table1.Add (this.c_x_spinbutton);
			global::Gtk.Table.TableChild w2 = ((global::Gtk.Table.TableChild)(this.table1 [this.c_x_spinbutton]));
			w2.TopAttach = ((uint)(1));
			...
			// Container child table1.Gtk.Table+TableChild
			this.c_y_spinbutton = new global::Gtk.SpinButton (-180, 180, 1);
			this.c_y_spinbutton.CanFocus = true;
			this.c_y_spinbutton.Name = "c_y_spinbutton";
			this.c_y_spinbutton.Adjustment.PageIncrement = 1;
			this.c_y_spinbutton.ClimbRate = 0.1;
			this.c_y_spinbutton.Digits = ((uint)(1));
			this.c_y_spinbutton.Numeric = true;
			this.c_y_spinbutton.Value = 0.5;
			this.table1.Add (this.c_y_spinbutton);
			global::Gtk.Table.TableChild w3 = ((global::Gtk.Table.TableChild)(this.table1 [this.c_y_spinbutton]));
			w3.TopAttach = ((uint)(2));
			...
			// Container child table1.Gtk.Table+TableChild
			this.crop_h_spinbutton = new global::Gtk.SpinButton (-180, 180, 1);
			this.crop_h_spinbutton.CanFocus = true;
			this.crop_h_spinbutton.Name = "crop_h_spinbutton";
			this.crop_h_spinbutton.Adjustment.PageIncrement = 1;
			this.crop_h_spinbutton.ClimbRate = 0.1;
			this.crop_h_spinbutton.Digits = ((uint)(1));
			this.crop_h_spinbutton.Numeric = true;
			this.crop_h_spinbutton.Value = 0.5;
			this.table1.Add (this.crop_h_spinbutton);
			global::Gtk.Table.TableChild w4 = ((global::Gtk.Table.TableChild)(this.table1 [this.crop_h_spinbutton]));
			w4.TopAttach = ((uint)(4));
			...
			// Container child table1.Gtk.Table+TableChild
			this.crop_w_spinbutton = new global::Gtk.SpinButton (-180, 180, 1);
			this.crop_w_spinbutton.CanFocus = true;
			this.crop_w_spinbutton.Name = "crop_w_spinbutton";
			this.crop_w_spinbutton.Adjustment.PageIncrement = 1;
			this.crop_w_spinbutton.ClimbRate = 0.1;
			this.crop_w_spinbutton.Digits = ((uint)(1));
			this.crop_w_spinbutton.Numeric = true;
			this.crop_w_spinbutton.Value = 0.5;
			this.table1.Add (this.crop_w_spinbutton);
			global::Gtk.Table.TableChild w5 = ((global::Gtk.Table.TableChild)(this.table1 [this.crop_w_spinbutton]));
			w5.TopAttach = ((uint)(3));
			...
			this.aspect_spinbutton = new global::Gtk.SpinButton (-180, 180, 1);
			this.aspect_spinbutton.CanFocus = true;
			this.aspect_spinbutton.Name = "aspect_spinbutton";
			this.aspect_spinbutton.Adjustment.PageIncrement = 1;
			this.aspect_spinbutton.ClimbRate = 0.1;
			this.aspect_spinbutton.Digits = ((uint)(1));
			this.aspect_spinbutton.Numeric = true;
			this.aspect_spinbutton.Value = 0.5;
			this.hbox1.Add (this.aspect_spinbutton);
			global::Gtk.Box.BoxChild w6 = ((global::Gtk.Box.BoxChild)(this.hbox1 [this.aspect_spinbutton]));
			w6.Position = 0;
			w6.Expand = false;
			w6.Fill = false;
			// Container child hbox1.Gtk.Box+BoxChild
			this.aspect_type_combobox = global::Gtk.ComboBox.NewText ();
			this.aspect_type_combobox.Name = "aspect_type_combobox";
			this.hbox1.Add (this.aspect_type_combobox);
			global::Gtk.Box.BoxChild w7 = ((global::Gtk.Box.BoxChild)(this.hbox1 [this.aspect_type_combobox]));
			w7.Position = 1;
			...
			global::Gtk.Table.TableChild w11 = ((global::Gtk.Table.TableChild)(this.table1 [this.label12]));
			...
			global::Gtk.Table.TableChild w15 = ((global::Gtk.Table.TableChild)(this.table1 [this.link_h_togglebutton]));
			...
			global::Gtk.Table.TableChild w16 = ((global::Gtk.Table.TableChild)(this.table1 [this.link_w_togglebutton]));
			...
			this.Hide ();
			this.aspect_spinbutton.ValueChanged += new global::System.EventHandler (this.OnAngleSpinbuttonValueChanged);
			this.crop_w_spinbutton.ValueChanged += new global::System.EventHandler (this.OnAngleSpinbuttonValueChanged);
			this.crop_h_spinbutton.ValueChanged += new global::System.EventHandler (this.OnAngleSpinbuttonValueChanged);
			this.c_y_spinbutton.ValueChanged += new global::System.EventHandler (this.OnAngleSpinbuttonValueChanged);
			this.c_x_spinbutton.ValueChanged += new global::System.EventHandler (this.OnAngleSpinbuttonValueChanged);
