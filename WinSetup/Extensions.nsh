...
Function ExtensionsCreate
    ...
    ${NSD_LV_SetItemText} $listview 2 1 ".CRW"
    ${NSD_LV_SetItemText} $listview 2 2 "Canon camera raw file"
    
    ${NSD_LV_InsertItem}  $listview 3   ""
    ${NSD_LV_SetItemText} $listview 3 1 ".PEF"
    ${NSD_LV_SetItemText} $listview 3 2 "Pentax camera raw file"
    
    ${NSD_LV_InsertItem}  $listview 4   ""
    ${NSD_LV_SetItemText} $listview 4 1 ".PTX"
    ${NSD_LV_SetItemText} $listview 4 2 "Pentax camera raw file"
    ...
    ${NSD_LV_SetCheckState} $listview 2 $ext_crw_state
    ${NSD_LV_SetCheckState} $listview 3 $ext_pef_state
...
Function ExtensionsDestroy
    ...
    ${NSD_LV_GetCheckState} $listview 2 $ext_crw_state
    ${NSD_LV_GetCheckState} $listview 3 $ext_pef_state
    ${NSD_LV_GetCheckState} $listview 4 $ext_ptx_state
FunctionEnd
