...
Function ExtensionsCreate
    ...
    ${NSD_LV_InsertColumn} $listview 0 120u "$(extension)"
    ${NSD_LV_InsertColumn} $listview 1 309u "$(description)"
...
;    ${NSD_LV_SetItemText} $listview 0 2 "${PRODUCT_NAME} stage file"
    ...
    ${NSD_LV_InsertItem}  $listview 0 ".CR2"
    ${NSD_LV_SetItemText} $listview 0 1 "$(cr2_description)"
    
    ${NSD_LV_InsertItem}  $listview 1 ".CRW"
    ${NSD_LV_SetItemText} $listview 1 1 "$(crw_description)"
    
    ${NSD_LV_InsertItem}  $listview 2 ".PEF"
    ${NSD_LV_SetItemText} $listview 2 1 "$(pef_description)"
    
    ${NSD_LV_InsertItem}  $listview 3 ".PTX"
    ${NSD_LV_SetItemText} $listview 3 1 "$(ptx_description)"
    
    ${NSD_LV_InsertItem}  $listview 4 ".NEF"
    ${NSD_LV_SetItemText} $listview 4 1 "$(nef_description)"
    
    ${NSD_LV_InsertItem}  $listview 5 ".NRF"
    ${NSD_LV_SetItemText} $listview 5 1 "$(nrf_description)"
    
    ${NSD_LV_InsertItem}  $listview 6 ".ARW"
    ${NSD_LV_SetItemText} $listview 6 1 "$(arw_description)"
    
    ${NSD_LV_InsertItem}  $listview 7 ".SRF"
    ${NSD_LV_SetItemText} $listview 7 1 "$(srf_description)"
    
    ${NSD_LV_InsertItem}  $listview 8 ".SR2"
    ${NSD_LV_SetItemText} $listview 8 1 "$(sr2_description)"
    
    ${NSD_LV_InsertItem}  $listview 9 ".DCR"
    ${NSD_LV_SetItemText} $listview 9 1 "$(dcr_description)"
    
    ${NSD_LV_InsertItem}  $listview 10 ".KDC"
    ${NSD_LV_SetItemText} $listview 10 1 "$(kdc_description)"
    
    ${NSD_LV_InsertItem}  $listview 11 ".ORF"
    ${NSD_LV_SetItemText} $listview 11 1 "$(orf_description)"
    
    ${NSD_LV_InsertItem}  $listview 12 ".MRW"
    ${NSD_LV_SetItemText} $listview 12 1 "$(mrw_description)"
    
    ${NSD_LV_InsertItem}  $listview 13 ".RAF"
    ${NSD_LV_SetItemText} $listview 13 1 "$(raf_description)"
    
    ${NSD_LV_InsertItem}  $listview 14 ".RAW"
    ${NSD_LV_SetItemText} $listview 14 1 "$(raw_description)"
    
    ${NSD_LV_InsertItem}  $listview 15 ".RW2"
    ${NSD_LV_SetItemText} $listview 15 1 "$(rw2_description)"
    
    ${NSD_LV_InsertItem}  $listview 16 ".SRW"
    ${NSD_LV_SetItemText} $listview 16 1 "$(srw_description)"
    
    ${NSD_LV_InsertItem}  $listview 17 ".BAY"
    ${NSD_LV_SetItemText} $listview 17 1 "$(bay_description)"
    
    ${NSD_LV_InsertItem}  $listview 18 ".X3F"
    ${NSD_LV_SetItemText} $listview 18 1 "$(x3f_description)"
    
    ${NSD_LV_InsertItem}  $listview 19 ".3FR"
    ${NSD_LV_SetItemText} $listview 19 1 "$(3fr_description)"
